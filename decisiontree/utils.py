...
def get_best_tree(data, labels, criterions=['gini', 'entropy', 'log_loss'], splitters=['best', 'random'], depths=np.arange(1, 1000), with_best=False, with_time=False, iterations = 100):
        ...
        for split in splitters:
            ...
            for depth in depths:
                ...
                for _ in range(iterations):
                    xtest, ytest, xtrain, ytrain = randomize_test(data, labels)
